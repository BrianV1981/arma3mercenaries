    ...
    class aliveStore {
        ...
        //category:  
		class other {
            displayName = "ALiVE Combat Support";
            kindOf = "Other";

			class B_Heli_Light_01_F {
                displayName = "ALiVE MH-9 Hummingbird Transport (30 Minutes)";
                description = "Purchasing this will give you 30 minutes of access to a MH-9 Hummingbird transport helicoptor, that can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support.";
                price = 20000;
                stock = 100;
				code = [player,"scripts\TRANSPORT3.sqf"] call BIS_fnc_execVM;
            };
			class B_Heli_Transport_01_F {
                displayName = "ALiVE UH-80 Ghost Hawk Transport (30 Minutes)";
                description = "Purchasing this will give you 30 minutes of access to a UH-80 Ghost Hawk transport helicoptor, that can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support.";
                price = 50000;
                stock = 100;
				code = [player,"scripts\TRANSPORT1.sqf"] call BIS_fnc_execVM;
            };
			class B_Heli_Transport_03_F {
                displayName = "ALiVE CH-67 Huron Transport (30 Minutes)";
                description = "Purchasing this will give you 30 minutes of access to a CH-67 Huron transport helicoptor, that can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support.";
                price = 100000;
                stock = 100;
				code = [player,"scripts\TRANSPORT2.sqf"] call BIS_fnc_execVM;
            };
			...
			class B_MBT_01_arty_F {
                ...
                price = 50000;
                stock = 100;
				code = [player,"scripts\ARTY1.sqf"] call BIS_fnc_execVM;
            };
