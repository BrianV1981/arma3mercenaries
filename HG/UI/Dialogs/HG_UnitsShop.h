...
/*
    ...
    Changes:
    - Integrated Grad Money system into the unit shop.
    - Updated the interaction logic to ensure compatibility with ACE interaction and Grad Money.
    - Updated UI elements and ensured they correctly trigger the appropriate actions.
    - Removed any outdated or unnecessary logic related to discount calculations.
    - General script cleanup and optimization for current project requirements.
*/
