// emergency combat alive store
//buyables set/store:
class aliveStore_2 {

    //category:  
    class Nother1 {
        displayName = "ALiVE Combat Support (NATO)";
        kindOf = "Other";
        tracking = 0;
    ...
    //category:  
    class Nother2 {
        displayName = "ALiVE Logistical Support (NATO)";
        kindOf = "Other";
        tracking = 0;
    ...
    //category:
    class Iother1 {
        displayName = "ALiVE Combat Support (INDEPENDENT)";
        kindOf = "Other";
        tracking = 0;
    ...
    //category:
    class Iother2 {
        displayName = "ALiVE Logistical Support (INDEPENDENT)";
        kindOf = "Other";
        tracking = 0;
