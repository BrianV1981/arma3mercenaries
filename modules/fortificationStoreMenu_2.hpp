...
class fortificationStore_2 {
    ...
    class Land_DragonsTeeth_01_1x1_old_F {
        ...
        price = 100;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_2,'Land_DragonsTeeth_01_1x1_old_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    ...
    class Land_RampConcrete_F {
        ...
        price = 100;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_2,'Land_RampConcrete_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    class Land_RampConcreteHigh_F {
        ...
        price = 200;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_2,'Land_RampConcreteHigh_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    ...
    price = 30;
    stock = 200;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PlasticBarrier_01_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class PlasticBarrier_01_red_F {
    ...
    price = 25;
    stock = 200;
    code = "if (player == (_this select 0)) then {[container_2,'PlasticBarrier_01_red_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class PlasticBarrier_01_white_F {
    ...
    price = 25;
    stock = 200;
    code = "if (player == (_this select 0)) then {[container_2,'PlasticBarrier_01_white_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PlasticBarrier_01_line_x2_F {
    ...
    price = 40;
    stock = 200;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PlasticBarrier_01_line_x2_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PlasticBarrier_01_line_x4_F {
    ...
    price = 70;
    stock = 200;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PlasticBarrier_01_line_x4_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class PlasticBarrier_02_grey_F {
    ...
    price = 60;
    stock = 200;
    code = "if (player == (_this select 0)) then {[container_2,'PlasticBarrier_02_grey_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class PlasticBarrier_02_yellow_F {
    ...
    price = 60;
    stock = 200;
    code = "if (player == (_this select 0)) then {[container_2,'PlasticBarrier_02_yellow_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PlasticBarrier_03_F {
    ...
    price = 70;
    stock = 200;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PlasticBarrier_03_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class PlasticBarrier_03_blue_F {
    ...
    price = 80;
    stock = 200;
    code = "if (player == (_this select 0)) then {[container_2,'PlasticBarrier_03_blue_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class PlasticBarrier_03_orange_F {
    ...
    class Land_Concrete_SmallWall_4m_F {
        ...
        price = 100;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_2,'Land_Concrete_SmallWall_4m_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    ...
    class Land_Concrete_SmallWall_8m_F {
        ...
        price = 150;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_2,'Land_Wall_IndCnc_2deco_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    ...
    class Land_Wall_IndCnc_4_F {
        ...
        price = 175;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_2,'Land_Wall_IndCnc_4_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
	...
	class Land_BrickWall_01_l_5m_F {
        ...
        price = 100;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_2,'Land_BrickWall_01_l_5m_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    ...
    class Land_BrickWall_02_l_5m_F {
        ...
        price = 100;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_2,'Land_BrickWall_02_l_5m_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    ...
    class Land_BrickWall_02_l_corner_v1_F {
        ...
        price = 100;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_2,'Land_BrickWall_02_l_corner_v1_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    ...
    class Land_BrickWall_03_l_5m_v1_F {
        ...
        price = 100;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_2,'Land_BrickWall_03_l_5m_v1_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    ...
    class Land_BrickWall_03_l_5m_v2_F {
        ...
        price = 100;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_2,'Land_BrickWall_03_l_5m_v2_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    ...
    class Land_BrickWall_04_l_5m_F {
        ...
        price = 100;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_2,'Land_BrickWall_04_l_5m_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    ...
    class Land_BrickWall_04_l_pole_F {
        ...
        price = 75;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_2,'Land_BrickWall_04_l_pole_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    ...
    class Land_BrickWall_04_l_pole_old_F {
        ...
        price = 75;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_2,'Land_BrickWall_04_l_pole_old_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    ...
    price = 100;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_WallCity_01_8m_blue_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_WallCity_01_8m_grey_F {
    ...
    price = 100;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_WallCity_01_8m_grey_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_WallCity_01_8m_pink_F {
    ...
    price = 100;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_WallCity_01_8m_pink_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_WallCity_01_8m_whiteblue_F {
    ...
    price = 100;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_WallCity_01_8m_whiteblue_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_WallCity_01_8m_yellow_F {
    ...
    price = 100;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_WallCity_01_8m_yellow_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_WallCity_01_8m_plain_grey_F {
    ...
    price = 100;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_WallCity_01_8m_plain_grey_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_WallCity_01_8m_plain_pink_F {
    ...
    price = 100;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_WallCity_01_8m_plain_pink_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_WallCity_01_8m_plain_whiteblue_F {
    ...
    price = 100;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_WallCity_01_8m_plain_whiteblue_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_WallCity_01_8m_plain_yellow_F {
    ...
    price = 100;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_WallCity_01_8m_plain_yellow_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_WallCity_01_gate_blue_F {
    ...
    price = 150;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_WallCity_01_gate_blue_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_WallCity_01_gate_grey_F {
    ...
    price = 150;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_WallCity_01_gate_grey_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_WallCity_01_gate_pink_F {
    ...
    price = 150;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_WallCity_01_gate_pink_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_WallCity_01_gate_yellow_F {
    ...
    price = 150;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_WallCity_01_gate_yellow_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_WallCity_01_pillar_pink_F {
    ...
    price = 75;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_WallCity_01_pillar_pink_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_WallCity_01_pillar_whiteblue_F {
    ...
    price = 75;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_WallCity_01_pillar_whiteblue_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_WallCity_01_pillar_yellow_F {
    ...
    price = 75;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_WallCity_01_pillar_yellow_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_WallCity_01_4m_blue_F {
    ...
    price = 100;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_WallCity_01_4m_blue_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_WallCity_01_4m_grey_F {
    ...
    price = 100;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_WallCity_01_4m_grey_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_WallCity_01_4m_pink_F {
    ...
    price = 100;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_WallCity_01_4m_pink_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_WallCity_01_4m_whiteblue_F {
    ...
    price = 100;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_WallCity_01_4m_whiteblue_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_WallCity_01_4m_yellow_F {
    ...
    price = 100;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_WallCity_01_4m_yellow_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_WallCity_01_4m_plain_blue_F {
    ...
    price = 100;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_WallCity_01_4m_plain_blue_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_WallCity_01_4m_plain_grey_F {
    ...
    price = 100;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_WallCity_01_4m_plain_grey_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_WallCity_01_4m_plain_pink_F {
    ...
    class Land_CanvasCover_02_F {
        ...
        price = 80;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_2,'Land_CanvasCover_02_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    class Land_MedicalTent_01_tropic_closed_F {
        ...
        price = 200;
        stock = 50;
        code = "if (player == (_this select 0)) then {[container_2,'Land_MedicalTent_01_tropic_closed_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    class Land_MedicalTent_01_MTP_closed_F {
        ...
        price = 200;
        stock = 50;
        code = "if (player == (_this select 0)) then {[container_2,'Land_MedicalTent_01_MTP_closed_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    class Land_MedicalTent_01_greenhex_closed_F {
        ...
        price = 200;
        stock = 50;
        code = "if (player == (_this select 0)) then {[container_2,'Land_MedicalTent_01_greenhex_closed_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    class Land_MedicalTent_01_brownhex_closed_F {
        ...
        price = 200;
        stock = 50;
        code = "if (player == (_this select 0)) then {[container_2,'Land_MedicalTent_01_brownhex_closed_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    class Land_MedicalTent_01_digital_closed_F {
        ...
        price = 200;
        stock = 50;
        code = "if (player == (_this select 0)) then {[container_2,'Land_MedicalTent_01_digital_closed_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    class Land_MedicalTent_01_white_IDAP_med_closed_F {
        ...
        price = 200;
        stock = 50;
        code = "if (player == (_this select 0)) then {[container_2,'Land_MedicalTent_01_white_IDAP_med_closed_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    class Land_MedicalTent_01_white_generic_closed_F {
        ...
        price = 100;
        stock = 50;
        code = "if (player == (_this select 0)) then {[container_2,'Land_MedicalTent_01_white_generic_closed_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    ...
    class Land_MedicalTent_01_floor_light_F {
        ...
        price = 50;
        stock = 50;
        code = "if (player == (_this select 0)) then {[container_2,'Land_MedicalTent_01_floor_light_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    class Land_MedicalTent_01_floor_dark_F {
        ...
        price = 50;
        stock = 50;
        code = "if (player == (_this select 0)) then {[container_2,'Land_MedicalTent_01_floor_dark_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    ...
    class CamoNet_OPFOR_F {
        ...
        price = 100;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_2,'CamoNet_OPFOR_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    class CamoNet_INDP_F {
        ...
        price = 100;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_2,'CamoNet_INDP_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    class CamoNet_BLUFOR_open_F {
        ...
        price = 100;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_2,'CamoNet_BLUFOR_open_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    class CamoNet_OPFOR_open_F {
        ...
        price = 100;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_2,'CamoNet_OPFOR_open_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    ...
    class CamoNet_BLUFOR_big_F {
        ...
        price = 200;
        stock = 50;
        code = "if (player == (_this select 0)) then {[container_2,'CamoNet_BLUFOR_big_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    class CamoNet_OPFOR_big_F {
        ...
        price = 200;
        stock = 50;
        code = "if (player == (_this select 0)) then {[container_2,'CamoNet_OPFOR_big_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    class CamoNet_INDP_big_F {
        ...
        price = 200;
        stock = 50;
        code = "if (player == (_this select 0)) then {[container_2,'CamoNet_INDP_big_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
};
    ...
    code = "if (player == (_this select 0)) then {[container_2,'Land_cargo_house_slum_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside; it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
        ...
        class Land_Cargo_House_V2_F {
            ...
            price = 50000;
            stock = 100;
            code = "if (player == (_this select 0)) then {[container_2,'Land_Cargo_House_V2_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
        };
        class Land_Cargo_House_V3_F {
            ...
            price = 50000;
            stock = 100;
            code = "if (player == (_this select 0)) then {[container_2,'Land_Cargo_House_V3_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
        };
    ...
    price = 50000;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_Medevac_house_V1_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside; it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
        ...
        class Land_Cargo_Patrol_V2_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then {[container_2,'Land_Cargo_Patrol_V2_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
        };
        ...
        class Land_Cargo_HQ_V1_F {
            ...
            price = 250000;
            stock = 50;
            code = "if (player == (_this select 0)) then {[container_2,'Land_Cargo_HQ_V1_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
        };
        class Land_Cargo_HQ_V2_F {
            ...
            price = 250000;
            stock = 50;
            code = "if (player == (_this select 0)) then {[container_2,'Land_Cargo_HQ_V2_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
        };
        class Land_Cargo_HQ_V3_F {
            ...
            price = 250000;
            stock = 50;
            code = "if (player == (_this select 0)) then {[container_2,'Land_Cargo_HQ_V3_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
        };
...
class Land_Medevac_HQ_V1_F {
    ...
    code = "if (player == (_this select 0)) then {[container_2,'Land_Medevac_HQ_V1_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside; it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
        ...
        class Land_Cargo_Tower_V1_F {
            ...
            price = 500000;
            stock = 50;
            code = "if (player == (_this select 0)) then {[container_2,'Land_Cargo_Tower_V1_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
        };
        class Land_Cargo_Tower_V2_F {
            ...
            price = 500000;
            stock = 50;
            code = "if (player == (_this select 0)) then {[container_2,'Land_Cargo_Tower_V2_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
        };
        class Land_Cargo_Tower_V3_F {
            ...
            price = 500000;
            stock = 50;
            code = "if (player == (_this select 0)) then {[container_2,'Land_Cargo_Tower_V3_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
        };
    ...
    class Land_Hangar_F {
        ...
        price = 100000;
        stock = 50;
        code = "if (player == (_this select 0)) then {[container_2,'Land_Hangar_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
	class Land_Airport_01_hangar_F {
        ...
        price = 100000;
        stock = 50;
        code = "if (player == (_this select 0)) then {[container_2,'Land_Airport_01_hangar_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    ...
    class Land_HelipadCivil_F {
        ...
        price = 5000;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_2,'Land_HelipadCivil_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction.';";
    };
    class Land_HelipadSquare_F {
        ...
        price = 5000;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_2,'Land_HelipadSquare_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction.';";
    };
    class Land_HelipadRescue_F {
        ...
        price = 5000;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_2,'Land_HelipadRescue_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction.';";
    };
    ...
    class Land_LampAirport_F {
        ...
        price = 100;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_2,'Land_LampAirport_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction.';";
    };
...
class PortableHelipadLight_01_yellow_F {
    ...
    class Land_Airport_Tower_F {
        ...
        price = 500000;
        stock = 200;
        code = "if (player == (_this select 0)) then {[container_2,'Land_Airport_Tower_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction.';";
    };
    ...
    class Land_Airport_01_controlTower_F {
        ...
        price = 500000;
        stock = 200;
        code = "if (player == (_this select 0)) then {[container_2,'Land_Airport_01_controlTower_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction.';";
    };
    ...
    class Land_Radar_Small_F {
		...
		class fortifications_lights {
			...
			class ACE_TacticalLadder {
                ...
                price = 200;
                stock = 400;
				code = "if (player == (_this select 0)) then {[container_2,'ACE_TacticalLadder'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class FirePlace_burning_F {
                ...
                price = 10;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'FirePlace_burning_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Land_TentLamp_01_standing_F {
                ...
                price = 20;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Land_TentLamp_01_standing_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Land_TentLamp_01_standing_red_F {
                ...
                price = 20;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Land_TentLamp_01_standing_red_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Land_TentLamp_01_suspended_F {
                ...
                price = 20;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Land_TentLamp_01_suspended_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };	
			...
			class Land_PortableLight_single_F {
				...
				price = 50;
				stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Land_PortableLight_single_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
			class Land_PortableLight_double_F {
                ...
                price = 75;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Land_PortableLight_double_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Land_LampStreet_small_F {
                ...
                price = 500;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Land_LampStreet_small_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Land_FloodLight_F {
				...
				price = 100;
				stock = 100;
				code = "if (player == (_this select 0)) then {[container_2,'Land_FloodLight_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
			};
...
class Land_PortableLight_02_single_black_F {
    ...
    price = 75;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PortableLight_02_single_black_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PortableLight_02_single_sand_F {
    ...
    price = 75;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PortableLight_02_single_sand_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PortableLight_02_double_black_F {
    ...
    price = 100;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PortableLight_02_double_black_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PortableLight_02_double_sand_F {
    ...
    price = 100;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PortableLight_02_double_sand_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PortableLight_02_quad_olive_F {
    ...
    price = 125;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PortableLight_02_quad_olive_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PortableLight_02_quad_yellow_F {
    ...
    price = 125;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PortableLight_02_quad_yellow_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PortableLight_02_quad_sand_F {
    ...
    price = 125;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PortableLight_02_quad_sand_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PortableLight_02_single_folded_olive_F {
    ...
    price = 75;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PortableLight_02_single_folded_olive_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PortableLight_02_single_folded_yellow_F {
    ...
    price = 75;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PortableLight_02_single_folded_yellow_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PortableLight_02_single_folded_black_F {
    ...
    price = 75;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PortableLight_02_single_folded_black_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Flag_POWMIA_F {
    ...
    price = 50;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Flag_POWMIA_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Flag_NATO_F {
    ...
    price = 50;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Flag_NATO_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Flag_Vrana_F {
    ...
    price = 50;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Flag_Vrana_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Flag_ARMEX_F {
    ...
    price = 50;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Flag_ARMEX_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Flag_Quontrol_F {
    ...
    price = 50;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Flag_Quontrol_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Flag_ION_F {
    ...
    price = 50;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Flag_ION_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Flag_Larkin_F {
    ...
    price = 50;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Flag_Larkin_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Flag_FD_Red_F {
    ...
    price = 50;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Flag_FD_Red_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Flag_FD_Blue_F {
    ...
    price = 50;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Flag_FD_Blue_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Flag_UK_F {
    ...
    price = 50;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Flag_UK_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Flag_AAF_F {
    ...
    price = 50;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Flag_AAF_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Flag_Altis_F {
    ...
    price = 50;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Flag_Altis_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Flag_FIA_F {
    ...
    price = 50;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Flag_FIA_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Flag_CSAT_F {
    ...
    price = 50;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Flag_CSAT_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Flag_AltisColonial_F {
    ...
    price = 50;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Flag_AltisColonial_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Flag_Blue_F {
    ...
    price = 50;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Flag_Blue_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Flag_Red_F {
    ...
    price = 50;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Flag_Red_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Flag_Green_F {
    ...
    price = 50;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Flag_Green_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Flag_White_F {
    ...
    price = 50;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Flag_White_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Flag_RedCrystal_F {
    ...
    price = 50;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Flag_RedCrystal_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Flag_UNO_F {
    ...
    price = 50;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Flag_UNO_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Flag_BI_F {
    ...
    code = "if (player == (_this select 0)) then {[container_2,'Flag_BI_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
	    ...
	    class fortifications_logiSupplies {
			...
			class ACE_Wheel {
                ...
                price = 50;
                stock = 10000;
				code = "if (player == (_this select 0)) then {[container_2,'ACE_Wheel'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class ACE_Track {
                ...
                price = 100;
                stock = 10000;
				code = "if (player == (_this select 0)) then {[container_2,'ACE_Track'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };	
			class Land_CanisterFuel_F {
                ...
                price = 50;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Land_CanisterFuel_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };	
			class FlexibleTank_01_sand_F {
                ...
                price = 500;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'FlexibleTank_01_sand_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class StorageBladder_01_fuel_sand_F {
                ...
                price = 10000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'StorageBladder_01_fuel_sand_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class B_Slingload_01_Fuel_F {
                ...
                price = 10000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'B_Slingload_01_Fuel_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Land_Pod_Heli_Transport_04_fuel_F {
                ...
                price = 10000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Land_Pod_Heli_Transport_04_fuel_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Land_BarrelWater_F {
                ...
                price = 80;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Land_BarrelWater_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };			
			class Land_StallWater_F {
                ...
                price = 125;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Land_StallWater_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class Land_WaterTank_F {
                ...
                price = 175;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Land_WaterTank_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class WaterPump_01_forest_F {
                ...
                price = 5000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'WaterPump_01_forest_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class B_Slingload_01_Medevac_F {
                ...
                price = 10000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'B_Slingload_01_Medevac_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Land_Pod_Heli_Transport_04_medevac_F {
                ...
                price = 10000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Land_Pod_Heli_Transport_04_medevac_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Box_NATO_AmmoVeh_F {
                ...
                price = 25000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Box_NATO_AmmoVeh_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class B_Slingload_01_Ammo_F {
                ...
                price = 25000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'B_Slingload_01_Ammo_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Land_Pod_Heli_Transport_04_ammo_F {
                ...
                price = 25000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Land_Pod_Heli_Transport_04_ammo_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class B_Slingload_01_Repair_F {
                ...
                price = 50000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'B_Slingload_01_Repair_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Land_Pod_Heli_Transport_04_repair_F {
                ...
                price = 50000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Land_Pod_Heli_Transport_04_repair_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
    ...
    price = 10;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PaperBox_01_small_closed_brown_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PaperBox_01_small_closed_brown_IDAP_F {
    ...
    price = 10;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PaperBox_01_small_closed_brown_IDAP_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PaperBox_01_small_closed_brown_food_F {
    ...
    price = 10;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PaperBox_01_small_closed_brown_food_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PaperBox_01_small_closed_white_med_F {
    ...
    price = 10;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PaperBox_01_small_closed_white_med_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
			...
			class Box_Wps_F {
                ...
                price = 25;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Box_Wps_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
    ...
    price = 100;
    stock = 50;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PlasticCase_01_large_black_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PlasticCase_01_large_black_CBRN_F {
    ...
    price = 100;
    stock = 50;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PlasticCase_01_large_black_CBRN_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PlasticCase_01_medium_black_F {
    ...
    price = 75;
    stock = 50;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PlasticCase_01_medium_black_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PlasticCase_01_medium_black_CBRN_F {
    ...
    price = 75;
    stock = 50;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PlasticCase_01_medium_black_CBRN_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PlasticCase_01_small_black_F {
    ...
    price = 50;
    stock = 50;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PlasticCase_01_small_black_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PlasticCase_01_small_black_CBRN_F {
    ...
    price = 50;
    stock = 50;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PlasticCase_01_small_black_CBRN_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PlasticCase_01_large_olive_F {
    ...
    price = 100;
    stock = 50;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PlasticCase_01_large_olive_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PlasticCase_01_medium_olive_F {
    ...
    price = 75;
    stock = 50;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PlasticCase_01_medium_olive_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PlasticCase_01_large_CBRN_F {
    ...
    price = 100;
    stock = 50;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PlasticCase_01_large_CBRN_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PlasticCase_01_medium_CBRN_F {
    ...
    price = 75;
    stock = 50;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PlasticCase_01_medium_CBRN_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PlasticCase_01_small_CBRN_F {
    ...
    price = 50;
    stock = 50;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PlasticCase_01_small_CBRN_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PlasticCase_01_large_gray_F {
    ...
    price = 100;
    stock = 50;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PlasticCase_01_large_gray_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PlasticCase_01_large_idap_F {
    ...
    price = 100;
    stock = 50;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PlasticCase_01_large_idap_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PlasticCase_01_medium_gray_F {
    ...
    price = 75;
    stock = 50;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PlasticCase_01_medium_gray_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PlasticCase_01_medium_idap_F {
    ...
    price = 75;
    stock = 50;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PlasticCase_01_medium_idap_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PlasticCase_01_small_gray_F {
    ...
    price = 50;
    stock = 50;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PlasticCase_01_small_gray_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PortableCabinet_01_bookcase_olive_F {
    ...
    price = 150;
    stock = 50;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PortableCabinet_01_bookcase_olive_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PortableCabinet_01_bookcase_sand_F {
    ...
    price = 150;
    stock = 50;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PortableCabinet_01_bookcase_sand_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PortableCabinet_01_closed_olive_F {
    ...
    price = 125;
    stock = 50;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PortableCabinet_01_closed_olive_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PortableCabinet_01_closed_black_F {
    ...
    price = 125;
    stock = 50;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PortableCabinet_01_closed_black_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PortableCabinet_01_closed_sand_F {
    ...
    price = 125;
    stock = 50;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PortableCabinet_01_closed_sand_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PortableCabinet_01_4drawers_sand_F {
    ...
    price = 150;
    stock = 50;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PortableCabinet_01_4drawers_sand_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_PortableCabinet_01_medical_F {
    ...
    price = 175;
    stock = 50;
    code = "if (player == (_this select 0)) then {[container_2,'Land_PortableCabinet_01_medical_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
		...
		class fortifications_supplyCrates {
			...
			class ACE_Box_Chemlights {
                ...
                price = 0;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'ACE_Box_Chemlights'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class ACE_medicalSupplyCrate {
                ...
                price = 1000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'ACE_medicalSupplyCrate'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class Box_NATO_WpsSpecial_F {
                ...
                price = 30000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Box_NATO_WpsSpecial_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Box_Syndicate_Ammo_F {
                ...
                price = 5000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Box_Syndicate_Ammo_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class ACE_Box_Ammo {
                ...
                price = 16000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'ACE_Box_Ammo'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Box_NATO_Ammo_F {
                ...
                price = 16000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Box_NATO_Ammo_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Box_NATO_Grenades_F {
                ...
                price = 6500;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Box_NATO_Grenades_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class Box_NATO_WpsLaunch_F {
                ...
                price = 60000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Box_NATO_WpsLaunch_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Box_NATO_Support_F {
                ...
                price = 20000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Box_NATO_Support_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class B_supplyCrate_F {
                ...
                price = 20000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'B_supplyCrate_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class ACE_Box_Misc {
                ...
                price = 20000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'ACE_Box_Misc'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class B_CargoNet_01_ammo_F {
                ...
                price = 149000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'B_CargoNet_01_ammo_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Box_NATO_Equip_F {
                ...
                price = 17000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Box_NATO_Equip_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Box_NATO_Uniforms_F {
                ...
                price = 25000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Box_NATO_Uniforms_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Box_IED_Exp_F {
                ...
                price = 5000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Box_IED_Exp_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class B_Slingload_01_Cargo_F {
                ...
                price = 5000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'B_Slingload_01_Cargo_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
	    ...
	    class fortifications_CSWs {
			...
			tracking = 0;
			 ...
			 class B_Static_Designator_01_F {
                ...
                price = 2000;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_2,'B_Static_Designator_01_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class I_HMG_02_F {
                ...
                price = 10000;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_2,'I_HMG_02_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
			};
			class I_HMG_02_high_F {
                ...
                price = 10000;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_2,'I_HMG_02_high_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
			};
		     class B_HMG_01_F {
                ...
                price = 15000;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_2,'B_HMG_01_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
			};
			class B_HMG_01_high_F {
                ...
                price = 15000;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_2,'B_HMG_01_high_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
			};
			class B_GMG_01_F {
                ...
                price = 15000;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_2,'B_GMG_01_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class B_GMG_01_high_F {
                ...
                price = 15000;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_2,'B_GMG_01_high_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
			};
			class B_Mortar_01_F {
                ...
                price = 15000;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_2,'B_Mortar_01_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class ace_dragon_staticAssembled {
                ...
                price = 5000;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_2,'ace_dragon_staticAssembled'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class B_static_AT_F {
                ...
                price = 25000;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_2,'B_static_AT_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class B_static_AA_F {
                ...
                price = 25000;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_2,'B_static_AA_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class B_AAA_System_01_F {
                ...
                price = 500000;
                stock = 20;
				code = "if (isServer) then {createVehicleCrew (_this select 2);(group this) setVariable ['Vcm_Disable',true]};if (player == (_this select 0)) then {[container_2,'B_AAA_System_01_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class B_Radar_System_01_F {
                ...
                price = 500000;
                stock = 20;
				code = "if (isServer) then {createVehicleCrew (_this select 2);(group this) setVariable ['Vcm_Disable',true]};if (player == (_this select 0)) then {[container_2,'B_Radar_System_01_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class B_SAM_System_03_F {
                ...
                price = 1000000;
                stock = 20;
				code = "if (isServer) then {createVehicleCrew (_this select 2);(group this) setVariable ['Vcm_Disable',true]};if (player == (_this select 0)) then {[container_2,'B_SAM_System_03_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class B_SAM_System_01_F {
                ...
                price = 1000000;
                stock = 20;
				code = "if (isServer) then {createVehicleCrew (_this select 2);(group this) setVariable ['Vcm_Disable',true]};if (player == (_this select 0)) then {[container_2,'B_SAM_System_01_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class B_Ship_Gun_01_F {
                ...
                price = 5000000;
                stock = 20;
				code = "if (isServer) then {createVehicleCrew (_this select 2);(group this) setVariable ['Vcm_Disable',true]};if (player == (_this select 0)) then {[container_2,'B_Ship_Gun_01_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
