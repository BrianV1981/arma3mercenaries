    ...
    class fortificationStore_2 {
		...
		class fortifications {
			...
			class Land_Razorwire_F {
                ...
                price = 50;
                stock = 1000;
				code = "if (player == (_this select 0)) then {[container_2,'Land_Razorwire_F'] call grad_fortifications_fnc_addFort}";
            };
			...
			class Land_TTowerBig_1_F {
                ...
                price = 50000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Land_TTowerBig_1_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_TTowerBig_2_F {
                ...
                price = 50000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Land_TTowerBig_2_F'] call grad_fortifications_fnc_addFort}";
            };
        };
		class Dfortifications {
			...
			class Target_PopUp3_Moving_90deg_Acc2_F {
                ...
                price = 50;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Target_PopUp3_Moving_90deg_Acc2_F'] call grad_fortifications_fnc_addFort}";
            };	
			class Land_Target_Oval_F {
                ...
                price = 50;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Land_Target_Oval_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_Target_Dueling_01_F {
                ...
                price = 50;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'Land_Target_Dueling_01_F'] call grad_fortifications_fnc_addFort}";
            };
	    ...
	    class Cfortifications {
			...
			class B_Slingload_01_Fuel_F {
                ...
                price = 50000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_2,'B_Slingload_01_Fuel_F'] call grad_fortifications_fnc_addFort}";
            };
	    ...
	    class Sweapons {
			...
			class ACE_B_SpottingScope {
                ...
                price = 1000;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_2,'ACE_B_SpottingScope'] call grad_fortifications_fnc_addFort}";
            };
			class I_HMG_02_F {
                ...
                price = 5000;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_2,'I_HMG_02_F'] call grad_fortifications_fnc_addFort}";
			};
			class I_HMG_02_high_F {
                ...
                price = 5000;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_2,'I_HMG_02_high_F'] call grad_fortifications_fnc_addFort}";
			};
		     class B_HMG_01_F {
			...
			class ace_dragon_staticAssembled {
                ...
                price = 5000;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_2,'ace_dragon_staticAssembled'] call grad_fortifications_fnc_addFort}";
            };
			class B_static_AT_F {
			...
			class B_AAA_System_01_F {
                ...
                price = 500000;
                stock = 20;
				code = "if (isServer) then {createVehicleCrew (_this select 2);(group this) setVariable ['Vcm_Disable',true]};if (player == (_this select 0)) then {[container_2,'B_AAA_System_01_F'] call grad_fortifications_fnc_addFort}";
            };
			class B_Radar_System_01_F {
                ...
                price = 500000;
                stock = 20;
				code = "if (isServer) then {createVehicleCrew (_this select 2);(group this) setVariable ['Vcm_Disable',true]};if (player == (_this select 0)) then {[container_2,'B_Radar_System_01_F'] call grad_fortifications_fnc_addFort}";
            };
			class B_SAM_System_03_F {
                ...
                price = 1000000;
                stock = 20;
				code = "if (isServer) then {createVehicleCrew (_this select 2);(group this) setVariable ['Vcm_Disable',true]};if (player == (_this select 0)) then {[container_2,'B_SAM_System_03_F'] call grad_fortifications_fnc_addFort}";
            };
			class B_SAM_System_01_F {
                ...
                price = 1000000;
                stock = 20;
				code = "if (isServer) then {createVehicleCrew (_this select 2);(group this) setVariable ['Vcm_Disable',true]};if (player == (_this select 0)) then {[container_2,'B_SAM_System_01_F'] call grad_fortifications_fnc_addFort}";
            };
			class B_Ship_Gun_01_F {
                ...
                price = 5000000;
                stock = 20;
				code = "if (isServer) then {createVehicleCrew (_this select 2);(group this) setVariable ['Vcm_Disable',true]};if (player == (_this select 0)) then {[container_2,'B_Ship_Gun_01_F'] call grad_fortifications_fnc_addFort}";
            };
			class B_Ship_MRLS_01_F {
                ...
                price = 10000000;
                stock = 20;
				code = "if (isServer) then {createVehicleCrew (_this select 2);(group this) setVariable ['Vcm_Disable',true]};if (player == (_this select 0)) then {[container_2,'B_Ship_MRLS_01_F'] call grad_fortifications_fnc_addFort}";
            };
        };	
		class Mammo {
