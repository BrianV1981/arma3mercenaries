    ...
    class fortificationStore_1 {
		...
		class fortifications {
			...
			class Land_BagFence_End_F {
                ...
                price = 10;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_BagFence_End_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_BagFence_Long_F {
                ...
                price = 20;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_BagFence_Long_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_BagFence_Round_F {
                ...
                price = 20;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_BagFence_Round_F'] call grad_fortifications_fnc_addFort}";
            };			
		    class Land_BagFence_Short_F {
                ...
                price = 15;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_BagFence_Short_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_HBarrier_1_F {
                ...
                price = 100;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_HBarrier_1_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_HBarrier_3_F {
                ...
                price = 300;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_HBarrier_3_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_HBarrier_5_F {
                ...
                price = 500;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_HBarrier_5_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_HBarrierBig_F {
                ...
                price = 500;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_HBarrierBig_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_HBarrierWall4_F {
                ...
                price = 600;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_HBarrierWall4_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_HBarrierWall6_F {
                ...
                price = 1000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_HBarrierWall6_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_HBarrierWall_corridor_F {
                ...
                price = 1000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_HBarrierWall_corridor_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_HBarrierWall_corner_F {
                ...
                price = 800;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_HBarrierWall_corner_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_CncBarrier_F {
                ...
                price = 200;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'Land_CncBarrier_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_CncBarrierMedium_F {
                ...
                price = 250;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'Land_CncBarrierMedium_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_CncBarrierMedium4_F {
                ...
                price = 300;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'Land_CncBarrierMedium4_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_Concrete_SmallWall_4m_F {
                ...
                price = 100;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Concrete_SmallWall_4m_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_Concrete_SmallWall_8m_F {
                ...
                price = 200;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Concrete_SmallWall_8m_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_Mil_WallBig_4m_F {
                ...
                price = 300;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Mil_WallBig_4m_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_Mil_WallBig_Corner_F {
                ...
                price = 100;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Mil_WallBig_Corner_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_Mil_WallBig_Gate_F {
                ...
                price = 300;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Mil_WallBig_Gate_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_CncWall1_F {
                ...
                price = 500;
                stock = 100;
				code = "if (player == (_this select 0)) then {code = [container_1,'Land_CncWall1_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_CncWall4_F {
                ...
                price = 1500;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'Land_CncWall4_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_BarGate_F {
                ...
                price = 100;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'Land_BarGate_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_RoadBarrier_01_F {
                ...
                price = 100;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'Land_RoadBarrier_01_F'] call grad_fortifications_fnc_addFort}";
            };
			class RoadBarrier_small_F {
                ...
                price = 100;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'RoadBarrier_small_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_PlasticBarrier_01_line_x6_F {
                ...
                price = 20;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_PlasticBarrier_01_line_x6_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_Crash_barrier_F {
                ...
                price = 50;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Crash_barrier_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_DragonsTeeth_01_4x2_new_F {
                ...
                price = 500;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'Land_DragonsTeeth_01_4x2_new_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_CzechHedgehog_01_new_F {
                ...
                price = 100;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'Land_CzechHedgehog_01_new_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_RampConcrete_F {
                ...
                price = 100;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'Land_RampConcrete_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_New_WiredFence_5m_F {
                ...
                price = 200;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_New_WiredFence_5m_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_New_WiredFence_10m_F {
                ...
                price = 400;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_New_WiredFence_10m_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_New_WiredFence_pole_F {
                ...
                price = 20;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_New_WiredFence_pole_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_NetFence_02_m_pole_F {
                ...
                price = 20;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_NetFence_02_m_pole_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_BackAlley_01_l_gate_F {
                ...
                price = 200;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_BackAlley_01_l_gate_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_NetFence_02_m_gate_v1_F {
                ...
                price = 100;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_NetFence_02_m_gate_v1_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_NetFence_02_m_gate_v2_F {
                ...
                price = 200;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_NetFence_02_m_gate_v2_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_BagBunker_Small_F {
                ...
                description = "Bunker (Small) can be built with the ACE Self Interaction Menu > Equipment > Fortifications.";
                 price = 500;
                 stock = 100;
				 code = "if (player == (_this select 0)) then {[container_1,'Land_BagBunker_Small_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_BagBunker_Large_F {
                ...
                price = 1500;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_BagBunker_Large_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_BagBunker_Tower_F {
                ...
                price = 2000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_BagBunker_Tower_F'] call grad_fortifications_fnc_addFort}";
			};
		...
		class Dfortifications {
			...
			class Target_PopUp3_Moving_90deg_Acc2_F {
                ...
                price = 50;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Target_PopUp3_Moving_90deg_Acc2_F'] call grad_fortifications_fnc_addFort}";
            };	
			class Land_Target_Oval_F {
                ...
                price = 50;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Target_Oval_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_Target_Dueling_01_F {
                ...
                price = 50;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Target_Dueling_01_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_Camping_Light_F {
                ...
                price = 20;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Camping_Light_F'] call grad_fortifications_fnc_addFort}";
            };			
			class Land_PortableLight_single_F {
                ...
                price = 50;
                stock = 200;
				code = "if (player == (_this select 0)) then {code = [container_1,'Land_PortableLight_single_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_PortableLight_double_F {
                ...
                price = 75;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_PortableLight_double_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_LampStreet_small_F {
                ...
                price = 1000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_LampStreet_small_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_LampAirport_F {
                ...
                price = 5000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_LampAirport_F'] call grad_fortifications_fnc_addFort}";
            };
			class PortableHelipadLight_01_blue_F {
                ...
                price = 50;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'PortableHelipadLight_01_blue_F'] call grad_fortifications_fnc_addFort}";
            };
			class PortableHelipadLight_01_red_F {
                ...
                price = 50;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'PortableHelipadLight_01_red_F'] call grad_fortifications_fnc_addFort}";
            };
		    class CamoNet_BLUFOR_F {
                ...
                price = 100;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'CamoNet_BLUFOR_F'] call grad_fortifications_fnc_addFort}";
            };
			class CamoNet_BLUFOR_open_F {
                ...
                price = 100;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'CamoNet_BLUFOR_open_F'] call grad_fortifications_fnc_addFort}";
			...
			class CamoNet_BLUFOR_big_F {
                ...
                price = 200;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'CamoNet_BLUFOR_big_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_HelipadCircle_F {
                ...
                price = 50;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_HelipadCircle_F'] call grad_fortifications_fnc_addFort}";
            };
			class Windsock_01_F {
                ...
                price = 50;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Windsock_01_F'] call grad_fortifications_fnc_addFort}";
            };
			class Flag_US_F {
                ...
                price = 50;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Flag_US_F'] call grad_fortifications_fnc_addFort}";
            };
			class Flag_POWMIA_F {
                ...
                price = 50;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Flag_POWMIA_F'] call grad_fortifications_fnc_addFort}";
            };
			...
			class Land_Tombstone_17_F {
                ...
                price = 500;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Tombstone_17_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_Grave_obelisk_F {
                ...
                price = 500;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Grave_obelisk_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_SignM_WarningMilitaryArea_english_F {
                ...
                price = 50;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_SignM_WarningMilitaryArea_english_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_SignM_WarningMilitaryVehicles_english_F {
                ...
                price = 30;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_SignM_WarningMilitaryVehicles_english_F'] call grad_fortifications_fnc_addFort}";
            };			
	    ...
	    class Cfortifications {
			...
			class ACE_Wheel {
                ...
                price = 50;
                stock = 10000;
				code = "if (player == (_this select 0)) then {[container_1,'ACE_Wheel'] call grad_fortifications_fnc_addFort}";
            };
			class ACE_Track {
                ...
                price = 100;
                stock = 10000;
				code = "if (player == (_this select 0)) then {[container_1,'ACE_Track'] call grad_fortifications_fnc_addFort}";
            };	
			class Land_CanisterFuel_F {
                ...
                price = 50;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_CanisterFuel_F'] call grad_fortifications_fnc_addFort}";
            };	
			...
			class StorageBladder_01_fuel_sand_F {
                ...
                price = 5000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'StorageBladder_01_fuel_sand_F'] call grad_fortifications_fnc_addFort}";
            };
			class B_Slingload_01_Fuel_F {
                ...
                price = 50000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'B_Slingload_01_Fuel_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_Pod_Heli_Transport_04_fuel_F {
                ...
                price = 50000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Pod_Heli_Transport_04_fuel_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_BarrelWater_F {
                ...
                price = 50;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_BarrelWater_F'] call grad_fortifications_fnc_addFort}";
            };			
			class Land_StallWater_F {
                ...
                price = 100;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_StallWater_F'] call grad_fortifications_fnc_addFort}";
            };
			class StorageBladder_02_water_forest_F {
                ...
                price = 1000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'StorageBladder_02_water_forest_F'] call grad_fortifications_fnc_addFort}";
            };		
			class WaterPump_01_forest_F {
                ...
                price = 15000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'WaterPump_01_forest_F'] call grad_fortifications_fnc_addFort}";
            };
			...
			class B_Slingload_01_Repair_F {
                ...
                price = 50000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'B_Slingload_01_Repair_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_Pod_Heli_Transport_04_repair_F {
                ...
                price = 50000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Pod_Heli_Transport_04_repair_F'] call grad_fortifications_fnc_addFort}";
            };
			class B_Slingload_01_Medevac_F {
                displayName = "Huron Medical Container (Medical Facility)";
                description = "The huron medical container (medical facility) will enable the use of personal aid kits (PAK's) in the field. It can be deployed with the ACE Self Interaction Menu > Equipment > Fortifications.";
                price = 5000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'B_Slingload_01_Medevac_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_Pod_Heli_Transport_04_medevac_F {
                displayName = "Taru Medical Pod";
                description = "The taru medical pod (medical facility) will enable the use of personal aid kits (PAK's) in the field. It can be deployed with the ACE Self Interaction Menu > Equipment > Fortifications.";
                price = 5000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Pod_Heli_Transport_04_medevac_F'] call grad_fortifications_fnc_addFort}";
            };
			class CargoNet_01_box_F {
                displayName = "Cargo Net Box Pallet (Empty )";
                description = "*The cargo net box pallet (empty) can be utilized to store scavanged equipment. You can deployed it with the ACE Self Interaction Menu > Equipment > Fortifications.";
                price = 200;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'CargoNet_01_box_F'] call grad_fortifications_fnc_addFort}";
            };
			class Box_Ammo_F {
                displayName = "Ammo Cache (Empty)";
                description = "The ammo cache (empty) can be utilized to store scavanged equipment. You can deployed it with the ACE Self Interaction Menu > Equipment > Fortifications.";
                price = 100;
                stock = 200;
			...
			class Land_PaperBox_01_small_closed_brown_food_F {
                displayName = "Cardboard Food Box (Empty)";
                description = "Cardboard food box (empty) can be utilized to store scavanged equipment. You can deployed it with the ACE Self Interaction Menu > Equipment > Fortifications.";
                price = 10;
                stock = 200;
			...
			class Box_NATO_Wps_F {
                ...
                price = 25000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Box_NATO_Wps_F'] call grad_fortifications_fnc_addFort}";
            };
			class Box_NATO_WpsSpecial_F {
                ...
                price = 30000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Box_NATO_WpsSpecial_F'] call grad_fortifications_fnc_addFort}";
            };
			class Box_NATO_Ammo_F {
                ...
                price = 16000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Box_NATO_Ammo_F'] call grad_fortifications_fnc_addFort}";
            };
			class Box_NATO_Grenades_F {
                ...
                price = 6500;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Box_NATO_Grenades_F'] call grad_fortifications_fnc_addFort}";
            };
			class Box_NATO_WpsLaunch_F {
                ...
                price = 60000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Box_NATO_WpsLaunch_F'] call grad_fortifications_fnc_addFort}";
            };
			class Box_NATO_Support_F {
                ...
                price = 20000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Box_NATO_Support_F'] call grad_fortifications_fnc_addFort}";
            };
			class B_supplyCrate_F {
                ...
                price = 20000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'B_supplyCrate_F'] call grad_fortifications_fnc_addFort}";
            };
			class B_CargoNet_01_ammo_F {
                ...
                price = 149000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'B_CargoNet_01_ammo_F'] call grad_fortifications_fnc_addFort}";
            };
			class Box_NATO_Equip_F {
                ...
                price = 17000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Box_NATO_Equip_F'] call grad_fortifications_fnc_addFort}";
            };
			class Box_NATO_Uniforms_F {
                ...
                price = 25000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Box_NATO_Uniforms_F'] call grad_fortifications_fnc_addFort}";
            };
			class Box_IED_Exp_F {
                ...
                price = 5000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Box_IED_Exp_F'] call grad_fortifications_fnc_addFort}";
            };
			class B_Slingload_01_Cargo_F {
                ...
                price = 5000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'B_Slingload_01_Cargo_F'] call grad_fortifications_fnc_addFort}";
            };
			class Land_Pod_Heli_Transport_04_box_F {
                ...
                price = 5000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Pod_Heli_Transport_04_box_F'] call grad_fortifications_fnc_addFort}";
            };
			...
			class Land_Pod_Heli_Transport_04_bench_F {
                ...
                price = 5000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Pod_Heli_Transport_04_bench_F'] call grad_fortifications_fnc_addFort}";
            };
	};
	    class Sweapons {
            ...
            kindOf = "other";
		     ...
		     class B_HMG_01_F {
                ...
                price = 15000;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'B_HMG_01_F'] call grad_fortifications_fnc_addFort}";
			};
			...
			class B_GMG_01_F {
                ...
                price = 15000;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'B_GMG_01_F'] call grad_fortifications_fnc_addFort}";
            };
