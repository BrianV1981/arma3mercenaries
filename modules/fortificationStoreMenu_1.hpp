    ...
    class fortificationStore_1 {
		...
		class fortifications {
			...
			class Land_BagFence_Corner_F {
                ...
                price = 10;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_BagFence_Corner_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
		    ...
		    class Land_BagFence_Short_F {
                ...
                price = 15;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_BagFence_Short_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class Land_Concrete_SmallWall_4m_F {
                ...
                price = 100;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Concrete_SmallWall_4m_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Land_Concrete_SmallWall_8m_F {
                ...
                price = 200;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Concrete_SmallWall_8m_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Land_Mil_WallBig_4m_F {
                ...
                price = 300;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Mil_WallBig_4m_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Land_Mil_WallBig_Corner_F {
                ...
                price = 100;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Mil_WallBig_Corner_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Land_Mil_WallBig_Gate_F {
                ...
                price = 300;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Mil_WallBig_Gate_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Land_CncWall1_F {
                ...
                price = 500;
                stock = 100;
				code = "if (player == (_this select 0)) then {code = [container_1,'Land_CncWall1_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Land_CncWall4_F {
                ...
                price = 1500;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'Land_CncWall4_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class Land_PlasticBarrier_01_line_x6_F {
                ...
                price = 20;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_PlasticBarrier_01_line_x6_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class Land_CzechHedgehog_01_new_F {
                ...
                price = 100;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'Land_CzechHedgehog_01_new_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Land_RampConcrete_F {
                ...
                price = 100;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'Land_RampConcrete_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Land_New_WiredFence_5m_F {
                ...
                price = 200;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_New_WiredFence_5m_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class Land_New_WiredFence_pole_F {
                ...
                price = 20;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_New_WiredFence_pole_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Land_NetFence_02_m_pole_F {
                ...
                price = 20;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_NetFence_02_m_pole_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Land_BackAlley_01_l_gate_F {
                ...
                price = 200;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_BackAlley_01_l_gate_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class Land_BagBunker_Small_F {
                ...
                description = "Bunker (Small) can be built with the ACE Self Interaction Menu > Equipment > Fortifications.";
                 price = 500;
                 stock = 100;
				 code = "if (player == (_this select 0)) then {[container_1,'Land_BagBunker_Small_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Land_BagBunker_Large_F {
                ...
                price = 1500;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_BagBunker_Large_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Land_BagBunker_Tower_F {
                ...
                price = 2000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_BagBunker_Tower_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
			};
			class Land_HBarrierTower_F {
                ...
                price = 2000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_HBarrierTower_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class Land_PillboxBunker_01_rectangle_F {
                ...
                price = 50000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_PillboxBunker_01_rectangle_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Land_PillboxBunker_01_big_F {
                ...
                price = 100000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_PillboxBunker_01_big_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
		...
		class Dfortifications {
			...
			class ACE_TacticalLadder {
                ...
                price = 200;
                stock = 400;
				code = "if (player == (_this select 0)) then {[container_1,'ACE_TacticalLadder'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class Land_TentLamp_01_standing_F {
                ...
                price = 20;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_TentLamp_01_standing_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Land_TentLamp_01_standing_red_F {
                ...
                price = 20;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_TentLamp_01_standing_red_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
		    ...
		    class CamoNet_BLUFOR_F {
                ...
                price = 100;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'CamoNet_BLUFOR_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class CamoNet_BLUFOR_open_F {
                ...
                price = 100;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'CamoNet_BLUFOR_open_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
			...
			class CamoNet_BLUFOR_big_F {
                ...
                price = 200;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'CamoNet_BLUFOR_big_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Land_HelipadCircle_F {
                ...
                price = 50;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_HelipadCircle_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Windsock_01_F {
                ...
                price = 50;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Windsock_01_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Flag_US_F {
                ...
                price = 50;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Flag_US_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Flag_POWMIA_F {
                ...
                price = 50;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Flag_POWMIA_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class Land_Target_Oval_F {
                ...
                price = 50;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Target_Oval_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Land_Target_Dueling_01_F {
                ...
                price = 50;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Target_Dueling_01_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Target_PopUp3_Moving_90deg_Acc2_F {
                ...
                price = 50;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Target_PopUp3_Moving_90deg_Acc2_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };	
        };
	    class Cfortifications {
			...
			class ACE_Wheel {
                ...
                description = "***RECOMMENDED TO HAVE AT ALL TIMES***ACE Spare Wheel can be deployed with the ACE Self Interaction Menu > Equipment > Fortifications. (consumed on use)";
                price = 50;
                stock = 10000;
				code = "if (player == (_this select 0)) then {[container_1,'ACE_Wheel'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class ACE_Track {
                ...
                price = 100;
                stock = 10000;
				code = "if (player == (_this select 0)) then {[container_1,'ACE_Track'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };	
			class Land_CanisterFuel_F {
                displayName = "Fuel Canister (15 Liters)";
                description = "***RECOMMENDED TO HAVE AT ALL TIMES***The fuel canister (15 liters) can be utilized to refuel vehicles in the field. You can deployed it with the ACE Self Interaction Menu > Equipment > Fortifications. (depletes on use)";
                price = 50;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_CanisterFuel_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };	
			...
			class StorageBladder_01_fuel_sand_F {
                ...
                price = 10000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'StorageBladder_01_fuel_sand_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class B_Slingload_01_Fuel_F {
                ...
                price = 10000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'B_Slingload_01_Fuel_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class Land_BarrelWater_F {
                ...
                price = 80;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_BarrelWater_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };			
			...
			class StorageBladder_02_water_forest_F {
                ...
                price = 5000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'StorageBladder_02_water_forest_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };		
			class WaterPump_01_forest_F {
                ...
                price = 10000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'WaterPump_01_forest_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class B_Slingload_01_Medevac_F {
                ...
                price = 5000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'B_Slingload_01_Medevac_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Land_Pod_Heli_Transport_04_medevac_F {
                ...
                price = 5000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Pod_Heli_Transport_04_medevac_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Box_NATO_AmmoVeh_F {
                ...
                price = 25000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Box_NATO_AmmoVeh_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class B_Slingload_01_Ammo_F {
                ...
                price = 25000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'B_Slingload_01_Ammo_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class Land_RepairDepot_01_green_F {
                ...
                price = 50000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_RepairDepot_01_green_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class CargoNet_01_box_F {
                ...
                description = "***ATTENTION***THIS IS THE ONLY EMPTY CONTAINER THAT CAN BE SLINGLOADED***The cargo net box pallet (empty) can be utilized to store scavanged equipment. You can deployed it with the ACE Self Interaction Menu > Equipment > Fortifications.";
                price = 250;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'CargoNet_01_box_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class ACE_medicalSupplyCrate {
                ...
                price = 1000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'ACE_medicalSupplyCrate'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class Box_NATO_WpsSpecial_F {
                ...
                price = 30000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Box_NATO_WpsSpecial_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Box_Syndicate_Ammo_F {
                ...
                price = 5000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Box_Syndicate_Ammo_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class ACE_Box_Ammo {
                ...
                price = 16000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'ACE_Box_Ammo'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Box_NATO_Ammo_F {
                ...
                price = 16000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Box_NATO_Ammo_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Box_NATO_Grenades_F {
                ...
                price = 6500;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Box_NATO_Grenades_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class Box_NATO_WpsLaunch_F {
                ...
                price = 60000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Box_NATO_WpsLaunch_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Box_NATO_Support_F {
                ...
                price = 20000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Box_NATO_Support_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class B_supplyCrate_F {
                ...
                price = 20000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'B_supplyCrate_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class ACE_Box_Misc {
                ...
                price = 20000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'ACE_Box_Misc'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class B_CargoNet_01_ammo_F {
                ...
                price = 149000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'B_CargoNet_01_ammo_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Box_NATO_Equip_F {
                ...
                price = 17000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Box_NATO_Equip_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Box_NATO_Uniforms_F {
                displayName = "Uniforms Box [NATO]";
                description = "Uniforms Box [NATO] contains an assortment of uniforms, stealth uniforms and ghillie suites. You can deploy it with the ACE Self Interaction Menu > Equipment > Fortifications.";
                price = 25000;
                stock = 200;
			...
			class Box_IED_Exp_F {
                ...
                description = "Explosives (IED) contains an assortmant of IED's. You can deploy it with the ACE Self Interaction Menu > Equipment > Fortifications.";
                price = 5000;
                stock = 200;
			...
			class B_Slingload_01_Cargo_F {
                ...
                price = 5000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'B_Slingload_01_Cargo_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class Land_Pod_Heli_Transport_04_bench_F {
                ...
                price = 5000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Pod_Heli_Transport_04_bench_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
	};
	    class Sweapons {
			...
			tracking = 1;
			 ...
			 class B_Static_Designator_01_F {
                ...
                price = 2000;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'B_Static_Designator_01_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class ACE_B_SpottingScope {
                ...
                price = 1000;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'ACE_B_SpottingScope'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class I_HMG_02_F {
                ...
                price = 10000;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'I_HMG_02_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
			};
			class I_HMG_02_high_F {
		     ...
		     class B_HMG_01_F {
                ...
                price = 15000;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'B_HMG_01_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
			};
			class B_HMG_01_high_F {
                ...
                price = 15000;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'B_HMG_01_high_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
			};
			class B_GMG_01_F {
                ...
                price = 15000;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'B_GMG_01_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class ace_dragon_staticAssembled {
                ...
                price = 5000;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'ace_dragon_staticAssembled'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class B_static_AT_F {
			...
			class B_static_AA_F {
                ...
                price = 25000;
                stock = 100;
				code = "if (player == (_this select 0)) then {[container_1,'B_static_AA_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class B_AAA_System_01_F {
                ...
                price = 500000;
                stock = 20;
				code = "if (isServer) then {createVehicleCrew (_this select 2);(group this) setVariable ['Vcm_Disable',true]};if (player == (_this select 0)) then {[container_1,'B_AAA_System_01_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class B_Radar_System_01_F {
                ...
                price = 500000;
                stock = 20;
				code = "if (isServer) then {createVehicleCrew (_this select 2);(group this) setVariable ['Vcm_Disable',true]};if (player == (_this select 0)) then {[container_1,'B_Radar_System_01_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class B_SAM_System_01_F {
                ...
                price = 1000000;
                stock = 20;
				code = "if (isServer) then {createVehicleCrew (_this select 2);(group this) setVariable ['Vcm_Disable',true]};if (player == (_this select 0)) then {[container_1,'B_SAM_System_01_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class B_Ship_Gun_01_F {
                ...
                price = 5000000;
                stock = 20;
				code = "if (isServer) then {createVehicleCrew (_this select 2);(group this) setVariable ['Vcm_Disable',true]};if (player == (_this select 0)) then {[container_1,'B_Ship_Gun_01_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class B_Ship_MRLS_01_F {
                ...
                price = 10000000;
                stock = 20;
				code = "if (isServer) then {createVehicleCrew (_this select 2);(group this) setVariable ['Vcm_Disable',true]};if (player == (_this select 0)) then {[container_1,'B_Ship_MRLS_01_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
        };	
		class Mammo {
			...
			class ACE_Box_82mm_Mo_Combo {
                ...
                stock = 10000;
				kindOf = "other";
				code = "if (player == (_this select 0)) then {[container_1,'ACE_Box_82mm_Mo_Combo'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Titan_AA {
