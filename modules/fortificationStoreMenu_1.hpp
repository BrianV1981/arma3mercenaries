    ...
    class Land_HBarrierWall6_F {
        ...
        price = 1000;
        stock = 200;
        code = "if (player == (_this select 0)) then {[container_1,'Land_HBarrierWall6_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
...
class fortifications_walls {
    ...
    class Land_CncBarrier_F {
        ...
        price = 200;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_1,'Land_CncBarrier_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    ...
    class Land_CncBarrierMedium_F {
        ...
        price = 250;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_1,'Land_CncBarrierMedium_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    ...
    class Land_BasaltKerb_01_2m_d_F {
        ...
        price = 50;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_1,'Land_BasaltKerb_01_2m_d_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    ...
    class Land_BasaltKerb_01_pile_F {
        ...
        price = 100;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_1,'Land_BasaltKerb_01_pile_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    ...
    class Land_BasaltWall_01_d_left_F {
        ...
        price = 100;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_1,'Land_BasaltWall_01_d_left_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    ...
    class Land_BasaltWall_01_d_right_F {
        ...
        price = 100;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_1,'Land_BasaltWall_01_d_right_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    ...
    price = 150;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_1,'Land_Fortress_01_innerCorner_70_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside; it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_Fortress_01_innerCorner_90_F {
    ...
    price = 150;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_1,'Land_Fortress_01_innerCorner_90_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside; it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_Fortress_01_innerCorner_110_F {
    ...
    price = 150;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_1,'Land_Fortress_01_innerCorner_110_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside; it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_Fortress_01_outterCorner_50_F {
    ...
    price = 150;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_1,'Land_Fortress_01_outterCorner_50_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside; it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_Fortress_01_outterCorner_80_F {
    ...
    price = 150;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_1,'Land_Fortress_01_outterCorner_80_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside; it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
...
class Land_Fortress_01_outterCorner_90_F {
    ...
    price = 150;
    stock = 100;
    code = "if (player == (_this select 0)) then {[container_1,'Land_Fortress_01_outterCorner_90_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside; it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
    ...
    class Land_BrickWall_01_l_end_F {
        ...
        price = 100;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_1,'Land_BrickWall_01_l_end_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    ...
    class Land_BrickWall_02_l_end_F {
        ...
        price = 100;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_1,'Land_BrickWall_02_l_end_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
    ...
    class Land_CamoConcreteWall_01_l_end_v1_F {
        ...
        price = 100;
        stock = 100;
        code = "if (player == (_this select 0)) then {[container_1,'Land_CamoConcreteWall_01_l_end_v1_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
    };
...
class Flag_BI_F {
    ...
    code = "if (player == (_this select 0)) then {[container_1,'Flag_BI_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
			...
			class Land_Monument_02_F {
                ...
                price = 1000;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Monument_02_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class Land_Tombstone_17_F {
                ...
                price = 500;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Tombstone_17_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class Land_Grave_obelisk_F {
                ...
                price = 500;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Grave_obelisk_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class Land_SignM_WarningMilitaryArea_english_F {
                ...
                price = 50;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_SignM_WarningMilitaryArea_english_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class Land_SignM_WarningMilitaryVehicles_english_F {
                ...
                price = 30;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_SignM_WarningMilitaryVehicles_english_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class Land_Target_Dueling_01_F {
                ...
                price = 50;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_Target_Dueling_01_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };
			...
			class Target_PopUp3_Moving_90deg_Acc2_F {
                ...
                price = 50;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Target_PopUp3_Moving_90deg_Acc2_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
            };	
        };
...
class Land_Orange_01_F {
    ...
    price = 5;
    stock = 500;
    code = "if (player == (_this select 0)) then {[container_1,'Land_Orange_01_F'] call grad_fortifications_fnc_addFort}; systemChat 'Your purchase is in the traders fortifications cargo.'; hint 'The traders fortifications cargo is located outside, it is the military-green Huron cargo container. Use ACE interaction > Fortifications.';";
};
