    ...
    class fortificationStore_1 {
		...
		class Dfortifications {
			...
			class Land_IRMaskingCover_02_F {
                ...
                price = 500;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_IRMaskingCover_02_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
			class Land_IRMaskingCover_01_F {
                ...
                price = 200;
                stock = 200;
				code = "if (player == (_this select 0)) then {[container_1,'Land_IRMaskingCover_01_F'] call grad_fortifications_fnc_addFort};systemChat 'Your purchase is in the traders fortifications cargo.';hint 'The traders fortifications cargo is loacted outside, it is the military-green huron cargo container. Use ACE interaction > Fortifications.';";
            };
