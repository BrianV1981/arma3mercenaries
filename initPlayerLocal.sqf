...
[player, 1, ["ACE_SelfActions", "ACE_Equipment"], [player,"mercenaryStore_2",container_2,aHelipad_2,"Private Security Services Contractors For Hire","Emergency Constellis Holdings, Inc. Services"] call grad_lbm_fnc_addInteraction;
