[] spawn { 
    ...
    // Calculate the starting position 2000 meters away from the player  
    ...
    // Monitor the Blackfish reaches the player  
    waitUntil {(_blackfish distance _playerPos) < 200};  // Set to allow damage within 100 meters of the player  
    ...
    waitUntil {(_blackfish distance _endPos) < 500};  // Adjust as needed to ensure it passes sufficiently  
