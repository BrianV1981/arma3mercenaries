...
[] spawn { 
    ...
    [_group] spawn {
        ...
        if (!isNull _parachute) then {
            ...
            private _unit = "if (isNil "radioSoundBlockTime") then { 
    radioSoundBlockTime = 0; 
}; 
...
[] spawn { 
    ...
    [_group] spawn {
        ...
        if (!isNull _parachute) then {
            ...
            private _unit = "B_CTRG_Soldier_LAT_tna_F" createUnit [position _parachute, (group player), format [
...
" createUnit [position _parachute, (group player), format [
                "this setVariable ['arma3mercenaries_aiUnit', '%1', true];
                this setVariable ['arma3mercenaries_groupID', '%2', true];
                this setVariable ['Vcm_Disable', true, true];
                (group this) setVariable ['Vcm_Disable', true];
