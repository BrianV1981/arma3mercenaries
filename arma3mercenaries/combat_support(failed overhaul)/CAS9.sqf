...
// Check if _cas9Thread exists in the missionNamespace and terminate it if it does
...
[
    ...
    [
        ...
        "B_APC_Wheeled_01_cannon_F", // Classname of vehicle
        "Badger IFV C",           // Callsign of vehicle
