/*
	...
	3. Rename 'waypointMarker_3' to any marker name that you want to use as the sector.
*/
...
private _markerName = "waypointMarker_3"; // Change this to the name of your sector marker
...
while {true} do {
    ...
    private _playersInSector = _markerPos nearEntities ["CAManBase", 150];
    ...
    // Iterate over each player found in the sector
    {
        if (isPlayer _x) then {
            ...
            for "_i" from 1 to 6 do {
                ...
                if ((_x distance _markerPos) > 150) then {
                ...
                if (_i == 2) then {
                    ...
                    private _basePos = getMarkerPos "waypointMarker_3";
                    ...
                    private _randomPos = [_basePos, _minRadius, _maxRadius, 3, 0, 0.2, 0, [], [getMarkerPos "waypointMarker_3", getMarkerPos "waypointMarker_3"]] call BIS_fnc_findSafePos;
