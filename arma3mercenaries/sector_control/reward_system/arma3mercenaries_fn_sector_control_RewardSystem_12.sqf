/*
	...
	3. Rename 'waypointMarker_12' to any marker name that you want to use as the sector.
*/
...
private _markerName = "waypointMarker_12"; // Change this to the name of your sector marker
...
while {true} do {
    ...
    private _playersInSector = _markerPos nearEntities ["CAManBase", 1000];
    ...
    // Iterate over each player found in the sector
    {
        if (isPlayer _x) then {
            ...
            for "_i" from 1 to 6 do {
                ...
                if ((_x distance _markerPos) > 1000) then {
                ...
                if (_i == 2) then {
                    ...
                    private _basePos = getMarkerPos "waypointMarker_12";
                    ...
                    private _randomPos = [_basePos, _minRadius, _maxRadius, 3, 0, 0.2, 0, [], [getMarkerPos "waypointMarker_12", getMarkerPos "waypointMarker_12"]] call BIS_fnc_findSafePos;
