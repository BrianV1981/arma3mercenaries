/*
	...
	3. Rename 'waypointMarker_8' to any marker name that you want to use as the sector.
*/
...
private _markerName = "waypointMarker_8"; // Change this to the name of your sector marker
           ...
           // Check if the player is already blocked or already receiving rewards
            ...
            for "_i" from 1 to 6 do {
                ...
                if (_i == 2) then {
                    ...
                    private _basePos = getMarkerPos "waypointMarker_8";
                    ...
                    private _randomPos = [_basePos, _minRadius, _maxRadius, 3, 0, 0.2, 0, [], [getMarkerPos "waypointMarker_8", getMarkerPos "waypointMarker_8"]] call BIS_fnc_findSafePos;
                    ...
                    if (_chance <= 0.5) then {
                        ...
                        [_randomPos, false, getMarkerPos "waypointMarker_8", _randomGroup, "OPF_F"] call ALIVE_spawnProfileGroup;
						sleep 5;
						[_randomPos, false, getMarkerPos "waypointMarker_8", _randomGroup, "OPF_F"] call ALIVE_spawnProfileGroup;
						sleep 5;
