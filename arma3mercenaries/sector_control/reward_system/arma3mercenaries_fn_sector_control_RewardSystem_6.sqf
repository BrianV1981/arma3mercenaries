/*
	...
	3. Rename 'waypointMarker_6' to any marker name that you want to use as the sector.
*/
...
private _markerName = "waypointMarker_6"; // Change this to the name of your sector marker
        ...
        if (isPlayer _x) then {
            ...
            for "_i" from 1 to 6 do {
                ...
                if (_i == 2) then {
                    ...
                    private _basePos = getMarkerPos "waypointMarker_6";
                    ...
                    private _randomPos = [_basePos, _minRadius, _maxRadius, 3, 0, 0.2, 0, [], [getMarkerPos "waypointMarker_6", getMarkerPos "waypointMarker_6"]] call BIS_fnc_findSafePos;
                    ...
                    if (_chance <= 0.5) then {
                        ...
                        [_randomPos, false, getMarkerPos "waypointMarker_6", _randomGroup, "OPF_F"] call ALIVE_spawnProfileGroup;
						sleep 5;
						[_randomPos, false, getMarkerPos "waypointMarker_6", _randomGroup, "OPF_F"] call ALIVE_spawnProfileGroup;
						sleep 5;
