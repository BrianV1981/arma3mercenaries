/*
	...
	3. Rename 'waypointMarker_4' to any marker name that you want to use as the sector.
*/
...
private _markerName = "waypointMarker_4"; // Change this to the name of your sector marker
...
while {true} do {
    ...
    private _playersInSector = _markerPos nearEntities ["CAManBase", 600];
    ...
    // Iterate over each player found in the sector
    {
        if (isPlayer _x) then {
            ...
            for "_i" from 1 to 6 do {
                ...
                if ((_x distance _markerPos) > 600) then {
                ...
                if (_i == 2) then {
                    ...
                    private _basePos = getMarkerPos "waypointMarker_4";
                    ...
                    private _randomPos = [_basePos, _minRadius, _maxRadius, 3, 0, 0.2, 0, [], [getMarkerPos "waypointMarker_4", getMarkerPos "waypointMarker_4"]] call BIS_fnc_findSafePos;
                    ...
                    if (_chance <= 0.5) then {
                        ...
                        [_randomPos, false, getMarkerPos "waypointMarker_4", _randomGroup, "OPF_F"] call ALIVE_spawnProfileGroup;
						sleep 5;
						[_randomPos, false, getMarkerPos "waypointMarker_4", _randomGroup, "OPF_F"] call ALIVE_spawnProfileGroup;
						sleep 5;
