/*
    ...
    Description:
    This script allows OPFOR players to "interrogate" BLUFOR and Independent soldiers within a 30-meter radius.
    Upon activation, the script first notifies the player about the number of BLUFOR and Independent soldiers being interrogated.
    ...
    and processing of intelligence. This provides gameplay incentives and strategic benefits to OPFOR factions.
*/
...
// Filter BLUFOR and Independent soldiers
_targetSoldiers = _targetSoldiers select {side _x in [west, independent] && _x != _player};

// Notify the player about the number of soldiers being interrogated
private _initialMessage = format ["%1 enemy soldiers (BLUFOR and Independent) are being interrogated. Payment will be received upon completion.", count _targetSoldiers];
