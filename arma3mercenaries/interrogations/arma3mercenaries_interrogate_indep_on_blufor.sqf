/*
    arma3mercenaries_interrogate_indep_on_blufor.sqf
    Author: BrianV1981

    Description:
    This script allows Independent players to "interrogate" BLUFOR soldiers within a 30-meter radius.
    Upon activation, the script notifies the player about the number of BLUFOR soldiers being interrogated.
...
private _bluforSoldiers = _pos nearEntities ["Man", 30];
