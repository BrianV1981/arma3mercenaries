...
class Sound_myTrack17 {
    ...
    sound[] = {"music\GM_vietnam.ogg", db+3, 1.0};
    titles[] = {};
};
class Sound_myTrack18 {
    name = "Sound_myTrack18";
    sound[] = {"music\GM_vietnam.ogg", db+3, 1.0};
    titles[] = {};
};
class Sound_myTrack19 {
    name = "Sound_myTrack19";
    sound[] = {"music\iranPlot.ogg", db+3, 1.0};
    titles[] = {};
};
class Sound_myTrack20 {
    name = "Sound_myTrack20";
    sound[] = {"music\lovin.ogg", db+3, 1.0};
    titles[] = {};
};
class Sound_myTrack21 {
    name = "Sound_myTrack21";
    sound[] = {"music\shelter.ogg", db+3, 1.0};
    titles[] = {};
};
class Sound_myTrack22 {
    name = "Sound_myTrack22";
    sound[] = {"music\hello.ogg", db+3, 1.0};
    titles[] = {};
};
class Sound_myTrack23 {
    name = "Sound_myTrack23";
    sound[] = {"music\rabbit.ogg", db+3, 1.0};
    titles[] = {};
};
class Sound_myTrack24 {
    name = "Sound_myTrack24";
    sound[] = {"music\mellow.ogg", db+3, 1.0};
    titles[] = {};
};
class Sound_myTrack25 {
    name = "Sound_myTrack25";
    sound[] = {"music\time.ogg", db+3, 1.0};
    titles[] = {};
};
class Sound_myTrack26 {
    name = "Sound_myTrack26";
    sound[] = {"music\risingSun.ogg", db+3, 1.0};
    titles[] = {};
};
class Sound_myTrack27 {
    name = "Sound_myTrack27";
    sound[] = {"music\lightMyFire.ogg", db+3, 1.0};
    titles[] = {};
};
class Sound_myTrack28 {
    name = "Sound_myTrack28";
    sound[] = {"music\sittin.ogg", db+3, 1.0};
    titles[] = {};
};
class Sound_myTrack29 {
    name = "Sound_myTrack29";
    sound[] = {"music\watchtower.ogg", db+3, 1.0};
    titles[] = {};
};