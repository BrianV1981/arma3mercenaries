/*
	...
	arma3mercenaries_fnc_task***.sqf
	Author: BrianV1981
	Description:

	Forces ALiVE into creating a mission by creating a temporary unit, calling a ALiVE command and killing/removing the unit. PLus lots of other stuuff is going on, but that is the gist of it...
...
private _taskType = "Assassination"; 
