...
// Check if _transportThread25 exists and terminate it if it does
if (!isNil "_transportThread25" && {not isNull _transportThread25}) then {
    terminate _transportThread25;
};
...
private _safePos = [[26448,24457,0], 0, 1000, 10, 0, 20, 0] call BIS_fnc_findSafePos;
