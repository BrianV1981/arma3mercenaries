...
// Check if _transportThread18 exists and terminate it if it does
if (!isNil "_transportThread18" && {not isNull _transportThread18}) then {
    terminate _transportThread18;
};
...
private _safePos = [[26670,24450,0], 0, 1000, 10, 0, 20, 0] call BIS_fnc_findSafePos;
