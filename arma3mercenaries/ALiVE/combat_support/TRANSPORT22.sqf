...
// Check if _transportThread22 exists and terminate it if it does
if (!isNil "_transportThread22" && {not isNull _transportThread22}) then {
    terminate _transportThread22;
};
...
private _safePos = [[26482,24457,0], 0, 1000, 10, 0, 20, 0] call BIS_fnc_findSafePos;
