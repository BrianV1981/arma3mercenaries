...
// Check if _cas2Thread exists and terminate it if it does
if (!isNil "_cas2Thread" && {not isNull _cas2Thread}) then {
    terminate _cas2Thread;
};
...
// private _safePos = [[27192,24959,0], 0, 1000, 10, 0, 20, 0] call BIS_fnc_findSafePos;

[
    "CAS",                         // CAS type
    [
        [27192,24959,0],                 // Position of vehicle
