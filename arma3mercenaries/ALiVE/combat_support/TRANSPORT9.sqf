...
// Check if _transportThread9 exists and terminate it if it does
if (!isNil "_transportThread9" && {not isNull _transportThread9}) then {
    terminate _transportThread9;
};
...
private _safePos = [[26700,24400,0], 0, 1000, 10, 0, 20, 0] call BIS_fnc_findSafePos;
