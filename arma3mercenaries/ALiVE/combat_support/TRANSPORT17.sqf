...
// Check if _transportThread17 exists and terminate it if it does
if (!isNil "_transportThread17" && {not isNull _transportThread17}) then {
    terminate _transportThread17;
};
...
private _safePos = [[27185,24525,0], 0, 1000, 10, 0, 20, 0] call BIS_fnc_findSafePos;
