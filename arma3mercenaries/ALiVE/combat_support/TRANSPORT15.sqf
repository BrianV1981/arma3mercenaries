...
// Check if _transportThread15 exists and terminate it if it does
if (!isNil "_transportThread15" && {not isNull _transportThread15}) then {
    terminate _transportThread15;
};
...
private _safePos = [[27146,24562,0], 0, 1000, 10, 0, 20, 0] call BIS_fnc_findSafePos;
