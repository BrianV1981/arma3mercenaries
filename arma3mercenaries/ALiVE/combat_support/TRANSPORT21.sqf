...
// Check if _transportThread21 exists and terminate it if it does
if (!isNil "_transportThread21" && {not isNull _transportThread21}) then {
    terminate _transportThread21;
};
...
private _safePos = [[26445,24485,0], 0, 1000, 10, 0, 20, 0] call BIS_fnc_findSafePos;
