...
// Check if _cas6Thread exists and terminate it if it does
if (!isNil "_cas6Thread" && {not isNull _cas6Thread}) then {
    terminate _cas6Thread;
};
...
// private _safePos = [[26818,24589,0], 0, 1000, 10, 0, 20, 0] call BIS_fnc_findSafePos;
