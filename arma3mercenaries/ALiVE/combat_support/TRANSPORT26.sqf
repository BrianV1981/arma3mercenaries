...
// Check if _transportThread26 exists and terminate it if it does
if (!isNil "_transportThread26" && {not isNull _transportThread26}) then {
    terminate _transportThread26;
};
...
private _safePos = [[26465,24439,0], 0, 1000, 10, 0, 20, 0] call BIS_fnc_findSafePos;
