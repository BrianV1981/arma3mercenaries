...
// Check if _transportThread1 exists and terminate it if it does
if (!isNil "_transportThread1" && {not isNull _transportThread1}) then {
    terminate _transportThread1;
};
...
private _safePos = [[26672,24523,0], 0, 1000, 10, 0, 20, 0] call BIS_fnc_findSafePos;
