...
// Check if _transportThread13 exists and terminate it if it does
if (!isNil "_transportThread13" && {not isNull _transportThread13}) then {
    terminate _transportThread13;
};
...
private _safePos = [[27056,24648,0], 0, 1000, 10, 0, 20, 0] call BIS_fnc_findSafePos;
