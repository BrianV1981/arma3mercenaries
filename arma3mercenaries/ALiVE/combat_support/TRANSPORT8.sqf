...
// Check if _transportThread8 exists and terminate it if it does
if (!isNil "_transportThread8" && {not isNull _transportThread8}) then {
    terminate _transportThread8;
};
...
private _safePos = [[26749,24457,0], 0, 1000, 10, 0, 20, 0] call BIS_fnc_findSafePos;
