...
// Check if _transportThread10 exists and terminate it if it does
if (!isNil "_transportThread10" && {not isNull _transportThread10}) then {
    terminate _transportThread10;
};
...
private _safePos = [[26716,24383,0], 0, 1000, 10, 0, 20, 0] call BIS_fnc_findSafePos;
