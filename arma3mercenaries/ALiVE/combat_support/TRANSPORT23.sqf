...
// Check if _transportThread23 exists and terminate it if it does
if (!isNil "_transportThread23" && {not isNull _transportThread23}) then {
    terminate _transportThread23;
};
...
private _safePos = [[26461,24473,0], 0, 1000, 10, 0, 20, 0] call BIS_fnc_findSafePos;
