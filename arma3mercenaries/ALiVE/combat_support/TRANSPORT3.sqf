...
// Check if _transportThread3 exists and terminate it if it does
if (!isNil "_transportThread3" && {not isNull _transportThread3}) then {
    terminate _transportThread3;
};
...
private _safePos = [[26702,24526,0], 0, 1000, 10, 0, 20, 0] call BIS_fnc_findSafePos;
