...
// Check if _cas4Thread exists and terminate it if it does
if (!isNil "_cas4Thread" && {not isNull _cas4Thread}) then {
    terminate _cas4Thread;
};
...
// private _safePos = [[27165,24992,0], 0, 1000, 10, 0, 20, 0] call BIS_fnc_findSafePos;

[
    "CAS",                         // CAS type
    [
        [27165,24992,0],                 // Position of vehicle
