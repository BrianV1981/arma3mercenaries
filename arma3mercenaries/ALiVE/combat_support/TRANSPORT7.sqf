...
// Check if _transportThread7 exists and terminate it if it does
if (!isNil "_transportThread7" && {not isNull _transportThread7}) then {
    terminate _transportThread7;
};
...
private _safePos = [[26432,24494,0], 0, 1000, 10, 0, 20, 0] call BIS_fnc_findSafePos;
