...
_spawnPosition = _spawnPosition getPos [2000, _spawnDirection]; // Get the position 100 meters away in the chosen direction 
...
if (isNull _enemyGroup) then {  
    ...
    private _taskType = "SabotageBuilding";  // "MilAssault","MilDefence","CivAssault","Assassination","TransportInsertion","DestroyVehicles","DestroyInfantry","SabotageBuilding"
