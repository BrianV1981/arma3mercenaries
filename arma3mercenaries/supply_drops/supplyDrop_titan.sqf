...
[] spawn { 
    ...
    _Cargo = createVehicle ["B_CargoNet_01_ammo_F", position _parachute, [], 0, 'NONE']; 
    ...
    _Cargo addMagazineCargoGlobal ["Titan_AT", 40]; 
    _Cargo addMagazineCargoGlobal ["Titan_AA", 40];
