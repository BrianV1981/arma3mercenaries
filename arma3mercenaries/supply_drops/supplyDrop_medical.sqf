...
[] spawn { 
    ...
    _Cargo = createVehicle ["C_IDAP_supplyCrate_F", position _parachute, [], 0, 'NONE']; 
	...
	_Cargo addItemCargoGlobal ["ACE_personalAidKit", 5];
	_Cargo addItemCargoGlobal ["ACE_bloodIV", 25];
	_Cargo addItemCargoGlobal ["ACE_bloodIV_500", 25];
	_Cargo addItemCargoGlobal ["ACE_bloodIV_250", 25];
	_Cargo addItemCargoGlobal ["ACE_epinephrine", 25];
	_Cargo addItemCargoGlobal ["ACE_morphine", 25];
	_Cargo addItemCargoGlobal ["ACE_fieldDressing", 100];
	_Cargo addItemCargoGlobal ["ACE_Splint", 25];
	
	_Cargo addItemCargoGlobal ["ACE_Humanitarian_Ration", 25];
	_Cargo addItemCargoGlobal ["ACE_Canteen", 25];

	_Cargo addItemCargoGlobal ["ACE_EarPlugs", 50];
	_Cargo addItemCargoGlobal ["ACE_CableTie", 100];
	_Cargo addItemCargoGlobal ["ACE_EntrenchingTool", 5];
	_Cargo addItemCargoGlobal ["ACE_Clacker", 5];
	_Cargo addItemCargoGlobal ["ACE_DefusalKit", 5];

	_Cargo addBackpackCargoGlobal ["ACE_TacticalLadder_Pack", 5];
	_Cargo addBackpackCargoGlobal ["B_Respawn_TentDome_F", 5];
