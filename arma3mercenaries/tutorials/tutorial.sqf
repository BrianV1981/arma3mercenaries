if (hasInterface) then {
    ...
    "Welcome to arma3mercenaries!" hintC [
        ...
        "Help even the battlefield. NATO is outnumbered! Get Paid to engage in combat! Earn 0 to 5,000 Cr per enemy killed (check the corpse for extra cash). Beware, penalties for harming civilians or allies are severe.",
		...
		"Help NATO forces push into enemy territory. Get paid to capture and hold critical sectors for up to one hour.",
        ...
        "Persistent systems include player inventory, group memberships, group inventory, player-owned vehicles, player-owned vehicle inventores, vehicle garages, static weapons, and fortifications.",
