...
[radio_2, ["Turn Off Radio",
{
	...
	radio_2 = "Land_FMradio_F" createVehicle [0, 0, 0];
	radio_2 setPosATL [_pos select 0, _pos select 1, _pos select 2];
	radio_2 setDir _dir;
	radioH_2 remoteExec ["terminate"];
	
	[radio_2, ["Play Radio", {radioH_2 = [] execVM "scripts\playRadio2.sqf"}, [], 6, false, true, "", "_target distance _this < 10"]] remoteExec ["addAction"];
...
radioH_2 = [] execVM "scripts\playRadio2.sqf";
