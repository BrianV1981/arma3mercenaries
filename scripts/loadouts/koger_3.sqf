...
for "_i" from 1 to 10 do {player addItemToVest "ACE_30Rnd_65x39_caseless_green_mag_Tracer_Dim";};
...
for "_i" from 1 to 9 do {player addItemToBackpack "ACE_CableTie";};
...
for "_i" from 1 to 6 do {player addItemToBackpack "10Rnd_50BW_Mag_F";};
player addItemToBackpack "ACE_30Rnd_65x39_caseless_green_mag_Tracer_Dim";
