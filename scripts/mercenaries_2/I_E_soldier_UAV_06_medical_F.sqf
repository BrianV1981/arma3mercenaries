...
"I_E_soldier_UAV_06_medical_F" createUnit [_randomSpawnPos, (group player), "this setVariable ['Vcm_Disable', true, true];", 0.5, "PRIVATE"];
...
"I_E_soldier_UAV_06_medical_F" createUnit [_randomSpawnPos, (group player), format [
