...
"I_C_Soldier_Bandit_3_F" createUnit [_randomSpawnPos, group player, "_this setVariable ['Vcm_Disable', true, true];chute = 'Steerable_Parachute_F' createVehicle [0,0,0]; chute setPos [getPos this select 0, getPos this select 1, 150]; this moveIndriver chute;", 0.5, "PRIVATE", 0.5];
